...
const { database, usptoClient, assignmentEngine, fileManager, pdfExtractor, exhibitExporter } = require('@uspto-search/core');
const { exportChainOfTitle } = exhibitExporter;
